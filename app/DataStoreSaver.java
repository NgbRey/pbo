...
public class DataStoreSaver {
    ...
    public static void loadAkun() {
        ...
        DataStore.getListAkun().clear(); // Hapus data lama dulu
    ...
    public static void loadProduk() {
        ...
        DataStore.getListProduk().clear(); // Hapus list agar tidak duplikat
    ...
    public static void saveTransaksi() {
        try (PrintWriter pw = new PrintWriter(new FileWriter(FILE_TRANSAKSI))) {
            ...
            for (Transaksi t : DataStore.getListTransaksi()) {
                // Format: ID_TRANSAKSI;ID_PELANGGAN;TANGGAL;STATUS;TOTAL;METODE_PEMBAYARAN
                pw.println(
                        t.getIdTransaksi() + ";" +
    ...
    public static void loadTransaksi() {
        ...
        DataStore.getListTransaksi().clear(); // Hapus transaksi lama
        ...
        try (Scanner sc = new Scanner(file)) {
            ...
            while (sc.hasNextLine()) {
                ...
                if (d[0].equals("ITEM")) {
                    // Format: ITEM;ID_TRANSAKSI;ID_PRODUK;QUANTITY
